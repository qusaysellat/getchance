                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="progname" type="text" class="form-input w-full @error('progname')  border-red-500 @enderror"
                            name="progname" value="{{ $studyProgram->progname }}" required autocomplete="progname" autofocus>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="level" type="text" class="form-input w-full @error('level')  border-red-500 @enderror"
                            name="level" value="{{ $studyProgram->level }}" required autocomplete="level" autofocus>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="duration" type="text" class="form-input w-full @error('duration')  border-red-500 @enderror"
                            name="duration" value="{{ $studyProgram->duration }}" required autocomplete="duration" autofocus>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <textarea id="description" class="form-input w-full @error('description')  border-red-500 @enderror"
                            name="description" value="" required autocomplete="write study program description here" autofocus>{{ $studyProgram->description }}</textarea>
